...
void CodXMB::ExportXMB(const WraithModel& Model, const std::string& FileName)
{
    ...
    // Write header
    WriteCommentBlock(Writer, "Generated by GreyhoundFX - A fork of Greyhound, a continuation of Wraith Archon");
    WriteCommentBlock(Writer, "Please credit Venom Modding, DTZxPorter & Scobalula for using it!");
