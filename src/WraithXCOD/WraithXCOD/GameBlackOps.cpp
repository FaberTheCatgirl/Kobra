...
bool GameBlackOps::LoadAssets()
{
    ...
    if (NeedsMaterials)
    {
        ...
        // Calculate maximum pool size
        auto MaximumPoolOffset = (MaterialCount * sizeof(BOXMaterial)) + MaterialOffset;
        // Store original offset
