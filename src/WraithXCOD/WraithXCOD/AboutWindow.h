...
protected:
    ...
    virtual void OnBeforeLoad()
    {
        ...
        // Setup about
        this->AddColorText("GreyhoundFX - A fork of Greyhound, a continuation of Wraith Archon, The Call of Duty asset exporter\n", RGB(0, 102, 255), 14, true);
        ...
        this->AddColorText("Scobalula & Venom Modding", RGB(52, 152, 219), 13, true);
        ...
        // Rehost
        this->AddColorText("GreyhoundFX, like Greyhound and Wraith Archon and its library, is licensed under the General Public License 3.0. You may distribute it and use it under the terms of the GPL 3.0, however these tools are provided as-is with no warranty provided. ", RGB(255, 255, 255), 13);
